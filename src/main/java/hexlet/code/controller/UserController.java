...
//    Если запрос содержит невалидные данные, то должен возвращаться ответ со статус-кодом 422
    ...
    @PostMapping()
    public User createUser(@RequestBody UserDto dto) throws NoSuchAlgorithmException, InvalidKeySpecException {
        return userService.createUser(dto);
    }

    @PutMapping(path = "/{id}")
    public User updateUser(@PathVariable long id, @RequestBody UserDto dto) throws NoSuchAlgorithmException, InvalidKeySpecException {
